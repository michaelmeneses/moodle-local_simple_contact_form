...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_confightmleditor('custom_html', get_string('custom_html', 'local_simple_contact_form'), get_string('custom_html_description', 'local_simple_contact_form'), ''));
}
